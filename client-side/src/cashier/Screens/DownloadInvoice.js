...
export default function DownloadScreen({ orderId}) {
  ...
  async function generateAndPrintInvoice(orderDetails) {
    ...
    const logo = "https://res.cloudinary.com/drselhsl4/image/upload/v1711549855/catering/yewirn2asngvxdxgbpwa.png";
...
<html>
  ...
  <body>
    ...
    <div class="section">
      ...
      <p><b>Date:</b> ${moment(orderDetails.createdAt).format(
        "ll"
      )}</p>
